...
namespace AsahiOhayo.Data.Extensions
{
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AppConfig>().HasData(
                new AppConfig() { Key = "HomeTitle", Value = "This is homepage of AsahiOhayo" },
                new AppConfig() { Key = "HomeKeyword", Value = "This is keyword of AsahiOhayo" },
                new AppConfig() { Key = "HomeDescription", Value = "This is description of AsahiOhayo" }
                );
