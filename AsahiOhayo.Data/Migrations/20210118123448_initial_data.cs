    ...
    public partial class initial_data : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Promitions", x => x.Id);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "HomeTitle", "This is homepage of AsahiOhayo" },
                    { "HomeKeyword", "This is keyword of AsahiOhayo" },
                    { "HomeDescription", "This is description of AsahiOhayo" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2021, 1, 18, 19, 34, 47, 267, DateTimeKind.Local).AddTicks(3832), 100000m, 200000m });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 1, "en-US", "Men shift", "ao-nam", "The shift product for men", "The shift product for men" },
                    { 4, 2, "en-US", "Women shift", "ao-nu", "The shift product for women", "The shift product for women" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "", "Mô tả sản phẩm", "vi-VN", "Áo Thun JP", 1, "ao-thun-jp", "Áo thun JP thời trang nam", "Áo thun JP thời trang nam" },
                    { 2, "", "Description of product", "en-US", "Men T-Shirt JP", 1, "men-t-shift-jp", "T-shirt JP for men", "T-shirt JP for men" }
                });
